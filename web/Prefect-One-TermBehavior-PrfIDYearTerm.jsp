<%-- 
    Document   : Prefect-One-TermBehavior-PrfIDYearTerm
    Created on : 25-Oct-2014, 12:37:49
    Author     : Prasanga
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            File reportFile = new File(application.getRealPath("/reports/Prf-Pbi/Prefect-One-TermBehavior-PrfIDYearTerm.jasper"));//your report_name.jasper file
