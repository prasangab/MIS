<%-- 
    Document   : Student-One-AllParentReports-StuID
    Created on : Sep 29, 2014, 11:46:49 AM
    Author     : Mr.Mic
--%>
...
<%@page import="net.sf.jasperreports.engine.*"%>
        ...
        <%
          ...
          //  String Year = request.getParameter("Year");
            ...
            File reportFile = new File(application.getRealPath("/reports/Student-One-AllParentReports-StuID.jasper"));//your report_name.jasper file
