<%-- 
    Document   : Prefect-One-ServiseDetails-PrfID
    Created on : 25-Oct-2014, 12:32:28
    Author     : Prasanga
--%>
...
<html>
    <head>
        ...
        <title>Prefect-One-ServiseDetails-PrfID</title>
    </head>
    <body>
        ...
        <%
            ...
            File reportFile = new File(application.getRealPath("/reports/Prf-Pbi/Prefect-One-ServiseDetails-PrfID.jasper"));//your report_name.jasper file
