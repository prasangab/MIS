<%-- 
    Document   : Student-AllinGradel-PersonalDetails-Grade
    Created on : Sep 29, 2014, 11:57:43 AM
    Author     : Mr.Mic
--%>
...
<%@page import="net.sf.jasperreports.engine.*"%>
        ...
        <%
          ...
          //  String Year = request.getParameter("Year");
            ...
            File reportFile = new File(application.getRealPath("/reports/Student-AllinGradel-PersonalDetails-Grade.jasper"));//your report_name.jasper file
