<%-- 
    Document   : Student-One-Parentreport-StuIDYear
    Created on : Sep 29, 2014, 11:30:31 AM
    Author     : Mr.Mic
--%>
...
<%@page import="net.sf.jasperreports.engine.*"%>
        ...
        <%
          ...
          //  String Year = request.getParameter("Year");
            ...
            File reportFile = new File(application.getRealPath("/reports/Student-One-Parentreport-StuIDYear.jasper"));//your report_name.jasper file
