<%-- 
    Document   : ExamBranch-AllinGrade-Exam-Grade
    Created on : 24-Oct-2014, 11:24:59
    Author     : Prasanga
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            File reportFile = new File(application.getRealPath("/reports/EBI-stu/ExamBranch-AllinGrade-Exam-Grade.jasper"));//your report_name.jasper file
