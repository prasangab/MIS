<%-- 
    Document   : TSI-One-StudentBehavior-TssIDYear
    Created on : 26-Oct-2014, 10:52:51
    Author     : Prasanga
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            File reportFile = new File(application.getRealPath("/reports/TSS-TSI/TSI-One-StudentBehavior-TssIDYear.jasper"));//your report_name.jasper file
