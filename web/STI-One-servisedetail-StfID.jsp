<%-- 
    Document   : STI-One-servisedetail-StfID
    Created on : 28-Oct-2014, 22:15:03
    Author     : Prasanga
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            File reportFile = new File(application.getRealPath("/reports/STI-Stf/STI-One-servisedetail-StfID.jasper"));//your report_name.jasper file
