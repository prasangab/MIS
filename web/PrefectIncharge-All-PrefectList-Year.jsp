<%-- 
    Document   : PrefectIncharge-All-PrefectList-Year
    Created on : 25-Oct-2014, 13:19:11
    Author     : Prasanga
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            File reportFile = new File(application.getRealPath("/reports/Prf-Pbi/PrefectIncharge-All-PrefectList-Year.jasper"));//your report_name.jasper file
