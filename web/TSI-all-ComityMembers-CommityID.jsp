<%-- 
    Document   : TSI-all-ComityMembers-CommityID
    Created on : 28-Oct-2014, 23:35:55
    Author     : Prasanga
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            File reportFile = new File(application.getRealPath("/reports/STI-Stf/TSI-all-ComityMembers-CommityID.jasper"));//your report_name.jasper file
