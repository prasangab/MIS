<%-- 
    Document   : stumenue
    Created on : Jan 16, 2015, 6:23:39 PM
    Author     : Mr.Mic
--%>
    ...
    <ul id="navbar">
        ...
        <li><a href="#">||Reports||</a>
            <ul>
                ...
                <li><a href="#">Student Progress Reports</a></li>                         
        ...
        <li><a href="#">||Gallery||</a>
            <ul>
                <li><a href="view_files_stu.jsp"> File</a></li>
                <li><a href="view_vedio_stu.jsp"> Video</a></li>
                <li><a href="view_audio_stu.jsp"> Audio</a></li>
                <li><a href="view_image_stu.jsp"> Image</a></li>
            </ul>
        </li>
