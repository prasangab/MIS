<%-- 
    Document   : STI-one-dissisiondetails-DissisionID
    Created on : 28-Oct-2014, 23:28:16
    Author     : Prasanga
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            File reportFile = new File(application.getRealPath("/reports/STI-Stf/STI-one-dissisiondetails-DissisionID.jasper"));//your report_name.jasper file
