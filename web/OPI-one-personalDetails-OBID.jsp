<%-- 
    Document   : OPI-one-personalDetails-OBID
    Created on : 26-Oct-2014, 17:16:33
    Author     : Prasanga
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            File reportFile = new File(application.getRealPath("/reports/OPI-ops/OPI-one-personalDetails-OBID.jasper"));//your report_name.jasper file
