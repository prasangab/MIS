<%-- 
    Document   : Prefect-One-PersonalData-PrefectID
    Created on : 25-Oct-2014, 10:30:11
    Author     : Prasanga
--%>
...
<html>
    <head>
        ...
        <title>Prefect-One-PersonalData-PrefectID</title>
    </head>
    <body>
        ...
        <%
            ...
            File reportFile = new File(application.getRealPath("/reports/Prf-Pbi/Prefect-One-PersonalData-PrefectID.jasper"));//your report_name.jasper file
